...
async def stream(client, _, mystic, user_id, result, chat_id, user_name, original_chat_id, video: Union[bool, str] = None, streamtype: Union[bool, str] = None, spotify: Union[bool, str] = None, forceplay: Union[bool, str] = None, userbot=None):
    ...
    if streamtype == "playlist":
        ...
        for search in result:
            ...
            if await is_active_chat(chat_id):
                ...
                try:
                    ...
                    continue
                await Bad.join_call(chat_id, original_chat_id, file_path, video=status, image=thumbnail, bot_id=bot_id)
        ...
        if await is_active_chat(chat_id):
            ...
            if not forceplay:
                db[chat_id] = []
            await Bad.join_call(chat_id, original_chat_id, file_path, video=None, bot_id=bot_id)
        ...
        if await is_active_chat(chat_id):
            ...
            if not forceplay:
                db[chat_id] = []
            await Bad.join_call(chat_id, original_chat_id, file_path, video=status, bot_id=bot_id)
        ...
        if await is_active_chat(chat_id):
            ...
            await Bad.join_call(chat_id, original_chat_id, file_path, video=status, image=thumbnail if thumbnail else None, bot_id=bot_id)
        ...
        if await is_active_chat(chat_id):
            ...
            if not forceplay:
                db[chat_id] = []
            await Bad.join_call(chat_id, original_chat_id, link, video=True if video else None, bot_id=bot_id)
