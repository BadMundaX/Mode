...
/skip : sᴋɪᴘ ᴛʜᴇ ᴄᴜʀʀᴇɴᴛ ᴘʟᴀʏɪɴɢ sᴛʀᴇᴀᴍ ᴀɴᴅ sᴛᴀʀᴛ sᴛʀᴇᴀᴍɪɴɢ ᴛʜᴇ ɴᴇxᴛ ᴛʀᴀᴄᴋ ɪɴ ǫᴜᴇᴜᴇ.

/end ᴏʀ /stop : ᴄʟᴇᴀʀs ᴛʜᴇ ǫᴜᴇᴜᴇ ᴀɴᴅ ᴇɴᴅ ᴛʜᴇ ᴄᴜʀʀᴇɴᴛ ᴘʟᴀʏɪɴɢ sᴛʀᴇᴀᴍ.
...
/authusers : sʜᴏᴡs ᴛʜᴇ ʟɪsᴛ ᴏғ ᴀᴜᴛʜ ᴜsᴇʀs ᴏғ ᴛʜᴇ ɢʀᴏᴜᴘ.
"""

HELP_3 = """
<u><b>ʙʀᴏᴀᴅᴄᴀsᴛ ғᴇᴀᴛᴜʀᴇ</b></u> [ᴏɴʟʏ ғᴏʀ sᴜᴅᴏᴇʀs] :

/broadcast [ᴍᴇssᴀɢᴇ ᴏʀ ʀᴇᴘʟʏ ᴛᴏ ᴀ ᴍᴇssᴀɢᴇ] : ʙʀᴏᴀᴅᴄᴀsᴛ ᴀ ᴍᴇssᴀɢᴇ ᴛᴏ sᴇʀᴠᴇᴅ ᴄʜᴀᴛs ᴏғ ᴛʜᴇ ʙᴏᴛ.

<u>ʙʀᴏᴀᴅᴄᴀsᴛɪɴɢ ᴍᴏᴅᴇs :</u>
<b>-pin</b> : ᴘɪɴs ʏᴏᴜʀ ʙʀᴏᴀᴅᴄᴀsᴛᴇᴅ ᴍᴇssᴀɢᴇs ɪɴ sᴇʀᴠᴇᴅ ᴄʜᴀᴛs.
<b>-pinloud</b> : ᴘɪɴs ʏᴏᴜʀ ʙʀᴏᴀᴅᴄᴀsᴛᴇᴅ ᴍᴇssᴀɢᴇ ɪɴ sᴇʀᴠᴇᴅ ᴄʜᴀᴛs ᴀɴᴅ sᴇɴᴅ ɴᴏᴛɪғɪᴄᴀᴛɪᴏɴ ᴛᴏ ᴛʜᴇ ᴍᴇᴍʙᴇʀs.
...
<b>ᴇxᴀᴍᴘʟᴇ:</b> <code>/broadcast -user -assistant -pin ᴛᴇsᴛɪɴɢ ʙʀᴏᴀᴅᴄᴀsᴛ</code>
"""
...
/block [ᴜsᴇʀɴᴀᴍᴇ ᴏʀ ʀᴇᴘʟʏ ᴛᴏ ᴀ ᴜsᴇʀ] : ʙʟᴏᴄᴋ ᴛʜᴇ ᴜsᴇʀ ғʀᴏᴍ ᴏᴜʀ ʙᴏᴛ.
/unblock [ᴜsᴇʀɴᴀᴍᴇ ᴏʀ ʀᴇᴘʟʏ ᴛᴏ ᴀ ᴜsᴇʀ] : ᴜɴʙʟᴏᴄᴋs ᴛʜᴇ ʙʟᴏᴄᴋᴇᴅ ᴜsᴇʀ.
/blockedusers : sʜᴏᴡs ᴛʜᴇ ʟɪsᴛ ᴏғ ʙʟᴏᴄᴋᴇᴅ ᴜsᴇʀs.
"""

HELP_6 = """
<u><b>ᴄʜᴀɴɴᴇʟ ᴘʟᴀʏ ᴄᴏᴍᴍᴀɴᴅs:</b></u>
...
/cplayforce or /cvplayforce : sᴛᴏᴘs ᴛʜᴇ ᴏɴɢᴏɪɴɢ sᴛʀᴇᴀᴍ ᴀɴᴅ sᴛᴀʀᴛs sᴛʀᴇᴀᴍɪɴɢ ᴛʜᴇ ʀᴇǫᴜᴇsᴛᴇᴅ ᴛʀᴀᴄᴋ.

/channelplay [ᴄʜᴀᴛ ᴜsᴇʀɴᴀᴍᴇ ᴏʀ ɪᴅ] ᴏʀ [ᴅɪsᴀʙʟᴇ] : ᴄᴏɴɴᴇᴄᴛ ᴄʜᴀɴɴᴇʟ ᴛᴏ ᴀ ɢʀᴏᴜᴘ ᴀɴᴅ sᴛᴀʀᴛs sᴛʀᴇᴀᴍɪɴɢ ᴛʀᴀᴄᴋs ʙʏ ᴛʜᴇ ʜᴇʟᴘ ᴏғ ᴄᴏᴍᴍᴀɴᴅs sᴇɴᴛ ɪɴ ɢʀᴏᴜᴘ.
"""

HELP_7 = """
<u><b>ɢʟᴏʙᴀʟ ʙᴀɴ ғᴇᴀᴛᴜʀᴇ</b></u> [ᴏɴʟʏ ғᴏʀ sᴜᴅᴏᴇʀs] :

/gban [ᴜsᴇʀɴᴀᴍᴇ ᴏʀ ʀᴇᴘʟʏ ᴛᴏ ᴀ ᴜsᴇʀ] : ɢʟᴏʙᴀʟʟʏ ʙᴀɴs ᴛʜᴇ ᴄʜᴜᴛɪʏᴀ ғʀᴏᴍ ᴀʟʟ ᴛʜᴇ sᴇʀᴠᴇᴅ ᴄʜᴀᴛs ᴀɴᴅ ʙʟᴀᴄᴋʟɪsᴛ ʜɪᴍ ғʀᴏᴍ ᴜsɪɴɢ ᴛʜᴇ ʙᴏᴛ.
/ungban [ᴜsᴇʀɴᴀᴍᴇ ᴏʀ ʀᴇᴘʟʏ ᴛᴏ ᴀ ᴜsᴇʀ] : ɢʟᴏʙᴀʟʟʏ ᴜɴʙᴀɴs ᴛʜᴇ ɢʟᴏʙᴀʟʟʏ ʙᴀɴɴᴇᴅ ᴜsᴇʀ.
...
/logger [ᴇɴᴀʙʟᴇ/ᴅɪsᴀʙʟᴇ] : ʙᴏᴛ ᴡɪʟʟ sᴛᴀʀᴛ ʟᴏɢɢɪɴɢ ᴛʜᴇ ᴀᴄᴛɪᴠɪᴛɪᴇs ʜᴀᴘᴘᴇɴ ᴏɴ ʙᴏᴛ.
...
/playforce ᴏʀ /vplayforce : sᴛᴏᴘs ᴛʜᴇ ᴏɴɢᴏɪɴɢ sᴛʀᴇᴀᴍ ᴀɴᴅ sᴛᴀʀᴛs sᴛʀᴇᴀᴍɪɴɢ ᴛʜᴇ ʀᴇǫᴜᴇsᴛᴇᴅ ᴛʀᴀᴄᴋ.
"""
...
<b>ᴇxᴀᴍᴘʟᴇ:</b> <code>/clone token paste here</code>

/rmbot – ᴅᴇʟᴇᴛᴇ ʏᴏᴜʀ ᴄʟᴏɴᴇᴅ ʙᴏᴛ.
<b>ᴇxᴀᴍᴘʟᴇ:</b> <code>/rmbot token paste here</code>
...
/clone – ᴄʟᴏɴᴇ ʏᴏᴜʀ ᴏᴡɴ ʙᴏᴛ ғʀᴏᴍ @OwnCloneBot.

<b><u>ᴀʟʟ Usᴇʀs :</b></u>
/mybot – ᴄʜᴇᴄᴋ ᴛʜᴇ ʙᴏᴛs ʏᴏᴜ’ᴠᴇ ᴄʟᴏɴᴇᴅ. [<a href="https://t.me/OwnCloneBot">sᴏʟᴏ-ᴍᴜsɪᴄ</a>]
/botinfo – ᴏɴʟʏ ғᴏʀ ʙᴏᴛ ᴏᴡɴᴇʀs ᴛᴏ ᴠɪᴇᴡ ʙᴏᴛ ɪɴғᴏ.

<b><u>ᴘʀᴇᴍɪᴜᴍ Usᴇʀs :</b></u>
...
<b>ᴇxᴀᴍᴘʟᴇ:</b> <code>/broadcast -user ᴛᴇsᴛɪɴɢ ʙʀᴏᴀᴅᴄᴀsᴛ</code>
"""

CLONE_HELP_3 = """
<b><u>ʟᴏɢɢɪɴɢ (ᴘʀᴇᴍɪᴜᴍ) :</b></u> [2/5]
/setlogger – sᴇᴛ ᴀ ʟᴏɢ ɢʀᴏᴜᴘ ғᴏʀ ʏᴏᴜʀ ʙᴏᴛ. <code>/setlogger -100xxxxxxxx</code>
/logger – ᴛᴜʀɴ ʟᴏɢɢɪɴɢ ᴏɴ ᴏʀ ᴏғғ. <code>/logger enable</code> ᴏʀ <code>/logger disable</code>
/logstatus – ᴄʜᴇᴄᴋ ʏᴏᴜʀ ᴄᴜʀʀᴇɴᴛ ʟᴏɢɢɪɴɢ sᴛᴀᴛᴜs ᴀɴᴅ ʟᴏɢ ɢʀᴏᴜᴘ.

<b><u>ᴏᴡɴᴇʀsʜɪᴘ (ᴘʀᴇᴍɪᴜᴍ) :</b></u>
/transfer ᴏʀ /transferowner – ᴛʀᴀɴsғᴇʀ ʙᴏᴛ ᴏᴡɴᴇʀsʜɪᴘ ᴛᴏ ᴀɴᴏᴛʜᴇʀ ᴜsᴇʀ (ʀᴇᴘʟʏ ᴏʀ ɢɪᴠᴇ @ᴜsᴇʀɴᴀᴍᴇ).
"""

CLONE_HELP_4 = """
<b><u>/play ʀᴀɴᴅᴏᴍ ᴄᴏɴᴛᴇɴᴛ (ᴘʀᴇᴍɪᴜᴍ) :</b></u> [3/5]
/setplaytext ᴏʀ /addplaytext – ᴀᴅᴅ ᴛᴇxᴛ ᴛᴏ ᴛʜᴇ ʀᴀɴᴅᴏᴍ sᴇᴀʀᴄʜ ᴍᴇssᴀɢᴇ ʟɪsᴛ.
/setplaysticker ᴏʀ /addplaysticker – ᴀᴅᴅ ᴀ sᴛɪᴄᴋᴇʀ ᴛᴏ ᴛʜᴇ ʀᴀɴᴅᴏᴍ sᴇᴀʀᴄʜ ᴍᴇssᴀɢᴇ ʟɪsᴛ (ʀᴇᴘʟʏ ᴛᴏ ᴀ sᴛɪᴄᴋᴇʀ).
/setplayanimation ᴏʀ /addplayanimation – ᴀᴅᴅ ᴀ GIF ᴛᴏ ᴛʜᴇ ʀᴀɴᴅᴏᴍ sᴇᴀʀᴄʜ ᴍᴇssᴀɢᴇ ʟɪsᴛ (ʀᴇᴘʟʏ ᴛᴏ ᴀ GIF).
/setplayvideo ᴏʀ /addplayvideo – ᴀᴅᴅ ᴀ ᴠɪᴅᴇᴏ ᴛᴏ ᴛʜᴇ ʀᴀɴᴅᴏᴍ sᴇᴀʀᴄʜ ᴍᴇssᴀɢᴇ ʟɪsᴛ (ʀᴇᴘʟʏ ᴛᴏ ᴀ ᴠɪᴅᴇᴏ).
/setplayphoto ᴏʀ /addplayphoto – ᴀᴅᴅ ᴀ ᴘʜᴏᴛᴏ ᴛᴏ ᴛʜᴇ ʀᴀɴᴅᴏᴍ sᴇᴀʀᴄʜ ᴍᴇssᴀɢᴇ ʟɪsᴛ (ʀᴇᴘʟʏ ᴛᴏ ᴀ ᴘʜᴏᴛᴏ).
/setstreamtext – sᴇᴛ ᴀ ᴄᴜsᴛᴏᴍ "ɴᴏᴡ ᴘʟᴀʏɪɴɢ" sᴛʀᴇᴀᴍ ᴄᴀᴘᴛɪᴏɴ. sᴜᴘᴘᴏʀᴛs {1} sᴏɴɢ, {2} ᴅᴜʀᴀᴛɪᴏɴ, {3} ʀᴇǫᴜᴇsᴛᴇᴅ ʙʏ.
/delplay, /resetplay ᴏʀ /delplaymode – ʀᴇsᴇᴛ ᴀʟʟ ʀᴀɴᴅᴏᴍ sᴇᴀʀᴄʜ-ᴍᴇssᴀɢᴇ ʟɪsᴛs.
/delstreamtext ᴏʀ /resetstreamtext – ʀᴇsᴇᴛ ᴛʜᴇ ᴄᴜsᴛᴏᴍ sᴛʀᴇᴀᴍ ᴄᴀᴘᴛɪᴏɴ.
"""

CLONE_HELP_5 = """
<b><u>/start ᴘᴀɴᴇʟ ᴄᴜsᴛᴏᴍɪᴢᴀᴛɪᴏɴ (ᴘʀᴇᴍɪᴜᴍ) :</b></u> [4/5]
ᴀʟʟ ᴏғ ᴛʜᴇsᴇ ᴀᴅᴅ ᴛᴏ ᴀ ʀᴀɴᴅᴏᴍ ʟɪsᴛ ғᴏʀ ʏᴏᴜʀ /start ᴍᴇssᴀɢᴇ.

/setstartimg ᴏʀ /addstartimg – ᴀᴅᴅ ᴀ ᴘʜᴏᴛᴏ (ʀᴇᴘʟʏ ᴛᴏ ᴏɴᴇ). /delstartimg – ʀᴇsᴇᴛ.
/setstartvideo ᴏʀ /addstartvideo – ᴀᴅᴅ ᴀ ᴠɪᴅᴇᴏ. /delstartvideo – ʀᴇsᴇᴛ.
/setstartsticker ᴏʀ /addstartsticker – ᴀᴅᴅ ᴀ sᴛɪᴄᴋᴇʀ. /delstartsticker – ʀᴇsᴇᴛ.
/setstartanimation ᴏʀ /addstartanimation – ᴀᴅᴅ ᴀ GIF. /delstartanimation – ʀᴇsᴇᴛ.
/setstartcaption ᴏʀ /addstartcaption – ᴀᴅᴅ ᴀ ᴄᴀᴘᴛɪᴏɴ (ʀᴇᴘʟʏ ᴛᴏ ᴛᴇxᴛ). /delstartcaption – ʀᴇsᴇᴛ.
/setstartbutton ᴏʀ /addstartbutton – <code>/addstartbutton Text - URL</code>. /delstartbutton – ʀᴇsᴇᴛ.
"""

CLONE_HELP_6 = """
<b><u>/start ᴘᴀɴᴇʟ ᴄᴜsᴛᴏᴍɪᴢᴀᴛɪᴏɴ – ᴘᴀʀᴛ 2 :</b></u> [5/5]
...
/viewstartsettings – ᴠɪᴇᴡ ᴄᴜʀʀᴇɴᴛ sᴛᴀʀᴛ ᴘᴀɴᴇʟ sᴇᴛᴛɪɴɢs.
/resetstartsetting – ʀᴇsᴇᴛ ᴇᴠᴇʀʏᴛʜɪɴɢ ᴀʙᴏᴠᴇ ɪɴ ᴏɴᴇ ɢᴏ.
